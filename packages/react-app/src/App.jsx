...
function App(props) {
  ...
  let contractConfig = useContractConfig();
  contractConfig = {
    ...contractConfig,
    externalContracts: cethconfig,
  };
  ...
  const purpose = useContractReader(readContracts, "WenPassiveIncomeProtocol", "purpose");

  // 📟 Listen for broadcast events
  const setPurposeEvents = useEventListener(readContracts, "WenPassiveIncomeProtocol", "SetPurpose", localProvider, 1);
